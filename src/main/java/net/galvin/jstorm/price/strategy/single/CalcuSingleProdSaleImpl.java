...
//        isBuyLog.setDescription(IsBuyLogEnum.IsDescription.MACHINE.name());
//        isBuyLog.setProductID(prodProduct.getProductId());
//        if(saleFlag){
//            try {
//                ProductLog productLog=new ProductLog();
//                productLog.setLogDate(new Date());
//                productLog.setProductId(prodProduct.getProductId());
//                productLog.setCategoryId(prodProduct.getBizCategoryId());
//                if(productLogService.getCountNums(productLog)<1){
//                    productLogService.saveLog(productLog);
//                }
//            } catch (Exception e1) {
//                Logging.INFO(e1+"insert buyflag log oracle failed"+prodProduct.getProductId());
//            }
//
//
//            if(Constants.N_FLAG.equalsIgnoreCase(prodProduct.getSaleFlag()) || StringUtil.isEmptyString(prodProduct.getSaleFlag())){
////				updateProductSaleFlag(prodProduct.getProductId(), Constants.Y_FLAG, msgFlag);
//                isBuyLog.setStatus("Y");
//                try {
//                    //httpsqsLogProducer.sendMessage(isBuyLog);
//                } catch (Exception e) {
//                    Logging.INFO(e+"insert buyflag log failed"+prodProduct.getProductId());
//                }
//                /**
//                 * 保存bug日志
//                 */
//                try {
//                    //isBuyLogService.insert(isBuyLog);
//                } catch (Exception e) {
//                    Logging.INFO(e+"insert buyflag log failed"+prodProduct.getProductId());
//                }
//            }
...
//				productLog.setProductId(prodProduct.getProductId());
//				productLog.setCategoryId(prodProduct.getBizCategoryId());
//				if(productnLogService.getCountNums(productLog)<1){
//					productnLogService.saveLog(productLog);
//				}
//            } catch (Exception e1) {
//                Logging.INFO(e1+"insert buyflag log oracle failed"+prodProduct.getProductId());
//            }
//            if (Constants.Y_FLAG.equalsIgnoreCase(prodProduct.getSaleFlag())) {
////                updateProductSaleFlag(prodProduct.getProductId(), Constants.N_FLAG, msgFlag);
//                isBuyLog.setStatus("N");
//                try {
//                    //httpsqsLogProducer.sendMessage(isBuyLog);
//                } catch (Exception e) {
//                    Logging.INFO(e+"insert buyflag log failed"+prodProduct.getProductId());
